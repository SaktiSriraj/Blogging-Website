...
const BlogPostCard = ({ content, author }) => {
    ...
    return (
        <Link to={`/blog/${id}`} className="flex gap-8 items-center border-b border-grey mb-4 pb-5">
            <div className="w-full">
                {/* username & date */}
                <div className="flex mt-10 gap-2 items-center mb-7">
                ...
                <div className="flex gap-4 mt-7">
                    <span className="btn-light py-1 px-4 rounded-xl">{ tags[0] }</span>
